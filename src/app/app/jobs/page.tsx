  ...
  return (
    <div className="space-y-6">
      <section className="newspaper-sheet">
        ...
        <h2 className="mt-3 font-serif text-5xl font-black">Ingestion jobs</h2>
        ...
        {params.started ? (
          <p className="mt-5 rounded border border-green-300 bg-green-50 p-3 text-sm text-green-800">
          ...
          jobs.map((job) => {
            ...
            return (
              <article key={job.id} className="ink-panel">
                ...
                <div className="mt-5 h-3 overflow-hidden rounded bg-stone-200">
                  <div className="h-full bg-stone-900" style={{ width: `${progress.percentComplete}%` }} />
                </div>
